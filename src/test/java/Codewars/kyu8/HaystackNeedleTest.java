...
public class HaystackNeedleTest {
    ...
    public void tests() {
        ...
        Assert.assertEquals("found the needle at position 3", HaystackNeedle.findNeedle(haystack1));
        Assert.assertEquals("found the needle at position 5", HaystackNeedle.findNeedle(haystack2));
        Assert.assertEquals("found the needle at position 30", HaystackNeedle.findNeedle(haystack3));
    }
}
